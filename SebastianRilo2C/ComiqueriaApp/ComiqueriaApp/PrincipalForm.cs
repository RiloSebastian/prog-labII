...
namespace ComiqueriaApp
{
    public partial class PrincipalForm : Form
    {
        ...
        public PrincipalForm()
        {
            ...
            //Productos
            Producto producto1 = new Comic("AMAZING SPIDER-MAN 01: SUERTE DE ESTAR VIVO", 5, 560.00, "Dan Slott", TipoComic.Occidental);
            ...
            Producto producto4 = new Comic("AKIRA 01 (EDICION CON SOBRECUBIERTA)", 10, 800.00, "KATSUHIRO OTOMO", TipoComic.Oriental);
        ...
        private void OnVenderClick(object sender, EventArgs e)
        {
            ...
            Form nuevaForm = new formVentas(this.productoSeleccionado); 
            DialogResult result = nuevaForm.ShowDialog(); //Agregar código para abrir ventasForm de forma MODAL

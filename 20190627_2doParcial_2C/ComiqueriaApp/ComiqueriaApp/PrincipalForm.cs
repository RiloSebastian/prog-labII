        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    ComiqueriaDAO.EliminarProducto(productoSeleccionado);
                }
            }
            catch (Exception ex)
            {
